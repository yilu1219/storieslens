...
[
  ...
  "Join with a code",
  "Hear choices",
  "Hear Yu read the squad choices",
  "How do you like to create?",
  "Tell and draw · easiest start",
  "Write and grow · school writing",
  "Build a bigger story · deeper feedback",
  "This is not a test. It only helps Yu choose the right kind of questions.",
  "Who is creating?",
  "I am 18 or older · independent account",
  "I am under 18 · creating with adult support",
  "What should we call you?",
  "What language will your story use?",
  "Start your story",
  "● Hold to Speak",
  "Press and hold to speak for as long as you need.",
  "Type your idea here…",
  "Already made something?",
  "Hear Yu guide me",
  "data-yu-read",
  "Set up your shared story once",
  "Name your story",
  "Type or say your story name",
  "data-title-speak",
  "data-title-voice-status",
  "What will you make?",
  "Choose one picture style",
  "See picture styles",
  "Storybook watercolor example",
  "Chinese ink watercolor example",
  "Cinematic animation example",
  "Graphic novel example",
  "Block World example",
  "data-style-card",
  "Add a style reference",
  "data-style-reference-file",
  "data-style-reference-permission",
  "Build your main character",
  "Add a drawing or photo",
  "Create squad &amp; generate my hero",
  "data-character-speak",
  "data-character-photo-consent",
  "data-character-preview-frame",
  'data-spark-speak',
  'src="writing-import.js?',
  "data-step-current",
  "data-step-next",
  "data-step-back",
  'src="start.js?',
...
assert(read("login.html").includes("Save the free first picture you already made"), "Registration should explain that it saves the picture made before sign-up");
